...
def main():
    ...
    # Fixed file paths
    # Note: Using the paths discovered in previous steps
    elevation_path = r'rasters_COP30/output_hh.tif'
    slope_path = r'viz/viz.hh_slope.tif'
    land_cover_path = r'land_cover_aligned.tif'
    dist_waterway_path = r'distance_to_waterways.tif'
    ...
    # Classes 0: not flooded, 1/2/3: flooded hazard levels
    counts_before = df_clean['flood_class'].value_counts().sort_index()
    print("\nClass distribution before undersampling:")
    print(counts_before)

    # flooded_pixels = count of 1 + 2 + 3
