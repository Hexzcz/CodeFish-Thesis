"""Attaching an arbitrary point to the road network.
...
from backend.domain.routing.edge_split import materialise_split
...
def snap_point_to_graph(
    ...
    if edge_cand is not None and (
        ...
        m_id = materialise_split(graph, edge_cand._edge, edge_cand._t)  # type: ignore[attr-defined]
